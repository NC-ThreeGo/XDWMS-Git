...
namespace Git.Storage.DataAccess.Report
{
	public partial class ReportsDataAccess : DbHelper<ReportsEntity>, IReports
	{
        ...
        public DataSet GetDataSource(ReportsEntity entity, List<ReportParamsEntity> list)
        {
            ...
            {
                command = DataCommandManager.CreateCustomDataCommand("XDWMS-Git", CommandType.Text, entity.DataSource);
            }
            else
            {
                command = DataCommandManager.CreateCustomDataCommand("XDWMS-Git", CommandType.StoredProcedure, entity.DataSource);
            }
            if (list != null)
            {
