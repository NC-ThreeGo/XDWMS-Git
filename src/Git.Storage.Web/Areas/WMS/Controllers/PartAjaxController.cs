...
using Git.Storage.Entity.WMS;

namespace Git.Storage.Web.Areas.Product.Controllers
{
    public class PartAjaxController : AjaxPage
    {
        /// <summary>
        /// 查询物料基础信息分页
        /// </summary>
        ...
        {
            string PartName = WebUtil.GetFormValue<string>("PartName", string.Empty);
            ...
            //     .Where<ProductEntity>("ProductName", ECondition.Like, "%" + PartName + "%")
            //     .Or<ProductEntity>("SnNum", ECondition.Like, "%" + PartName + "%")
            //     .Or<ProductEntity>("BarCode", ECondition.Like, "%" + PartName + "%")
            //     .End<ProductEntity>();
            //}
            //if (!CateNum.IsEmpty())
            //{
